...
| Admin/arbitrator abuse | No arbitrary escrow withdrawal, bounded actions and audit log | Compromised role signer |
...
| Replayed check-in | Server nonce, booking/renter binding, short expiry, one-time consume | Shared live code inside expiry |
...
| Signature replay/wrong network | Origin/network/nonce/expiry binding and Mainnet recheck | Stolen short-lived session |
